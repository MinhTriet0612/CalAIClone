...
2. Nguyên lý Độ phức tạp Cyclomatic (McCabe, 1976)  Đây là vũ khí "hạng nặng" để chốt hạ với thầy.
...
Tóm tắt chiến thuật làm Báo cáo:
Bạn không cần áp dụng TẤT CẢ các kỹ thuật này cho mọi chức năng. Hãy chọn 1 chức năng đơn giản để demo Phân hoạch tương đương & Giá trị biên, chọn 1 chức năng logic phức tạp để demo Đồ thị trạng thái hoặc Cause-Effect, và trích xuất 1 đoạn code cốt lõi để tính toán McCabe.
Làm đúng như vậy, thầy Hào sẽ thấy bạn không chỉ là một thợ code, mà là một kỹ sư Đảm bảo chất lượng thực thụ biết vận dụng lý thuyết vào thực tiễn! Bạn có muốn mình cùng bạn thử tính McCabe cho một đoạn code mẫu không?
