...
### 8.1. Mẫu AAA (Arrange - Act - Assert)
...
### 8.2. Độc lập dữ liệu & Trạng thái (Idempotency)
...
### 8.3. Xử lý Thời gian (Time & Dates)
...
### 8.4. Rich Assertions (Kiểm chứng giàu ngữ nghĩa)
...
### 8.5. Nguyên tắc DAMP thay vì DRY trong Test
